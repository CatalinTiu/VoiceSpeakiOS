...
class ViewController: UIViewController, SFSpeechRecognizerDelegate {
    ...
    private func startRecording() {
        ...
        guard let recognizer = SFSpeechRecognizer(locale: Locale.init(identifier: "ro")), recognizer.isAvailable else {
    ...
    private func updateUI(withResult result: SFSpeechRecognitionResult) {
        ...
        let options = TranslatorOptions(sourceLanguage: .romanian, targetLanguage: .english)
        let roengTranslator = Translator.translator(options: options)
        ...
        roengTranslator.downloadModelIfNeeded(with: conditions) { error in
            guard error == nil else { return }

            // Model downloaded successfully. Okay to start translating.
            
        roengTranslator.translate(result.bestTranscription.formattedString) { translatedText, error in
